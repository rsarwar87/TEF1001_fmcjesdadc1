...
ad_ip_files axi_dmac [list \
  ...
  $ad_hdl_dir/source/ip_library/util_axis_fifo/util_axis_fifo.v \
  $ad_hdl_dir/source/ip_library/util_axis_fifo/address_sync.v \
  $ad_hdl_dir/source/ip_library/common/ad_mem_asym.v \
  inc_id.vh \
  resp.vh \
