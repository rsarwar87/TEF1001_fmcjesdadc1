...
ad_ip_files avl_dacfifo [list\
  $ad_hdl_dir/source/ip_library/common/util_delay.v \
  $ad_hdl_dir/source/ip_library/common/ad_b2g.v \
  $ad_hdl_dir/source/ip_library/common/ad_g2b.v \
  $ad_hdl_dir/source/ip_library/common/ad_mem.v \
