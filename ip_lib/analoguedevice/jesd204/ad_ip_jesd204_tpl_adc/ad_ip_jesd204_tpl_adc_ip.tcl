...
source $ad_hdl_dir/scripts/ip_lib/adi_ip_xilinx.tcl
...
adi_ip_files ad_ip_jesd204_tpl_adc [list \
  ...
  "$ad_hdl_dir/source/ip_library/xilinx/common/up_xfer_cntrl_constr.xdc" \
  "$ad_hdl_dir/source/ip_library/xilinx/common/ad_rst_constr.xdc" \
  "$ad_hdl_dir/source/ip_library/xilinx/common/up_xfer_status_constr.xdc" \
  "$ad_hdl_dir/source/ip_library/xilinx/common/up_clock_mon_constr.xdc" \
