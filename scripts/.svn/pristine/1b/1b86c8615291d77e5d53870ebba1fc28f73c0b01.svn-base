  ...
  namespace eval VIV {
    ...
    #read args
      ...
      if {[file exists ${TE::BD_PATH}/${TE::SHORTDIR}/]} {
        ...
        #search for revision folder only (in case complete PCB rev has different design) 
        ...
        if {[file exists ${TE::BD_PATH}/${series_name}/]} {
          set bd_folder ${TE::BD_PATH}/${series_name}/
        }
      }
