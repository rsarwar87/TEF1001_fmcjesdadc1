...
HDL_PATH := $(subst scripts/ip_lib/library.mk,,$(lastword $(MAKEFILE_LIST)))
HDL_LIBRARY_PATH=$(HDL_PATH)source/ip_library/
include $(HDL_PATH)scripts/quiet.mk
...
GENERIC_DEPS += $(HDL_PATH)scripts/ip_lib/adi_env.tcl
...
INTEL_DEPS += $(HDL_PATH)scripts/ip_lib/adi_ip_intel.tcl
...
XILINX_DEPS += $(HDL_PATH)scripts/ip_lib/adi_ip_xilinx.tcl
